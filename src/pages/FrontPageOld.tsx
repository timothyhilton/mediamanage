            ...
            <div>
                <section className="flex flex-col w-full overflow-hidden bg-white lg:flex-row sm:mx-auto">
                    ...
                    <div className="relative lg:w-1/2">
                        <img src="/storage/themes/custom/hero.jpg" alt="Hero Image" className="object-cover w-full lg:absolute h-80 lg:h-full"></img>
                    </div>
                </section>
                            ...
                            <div className="box-border flex flex-col items-start h-full px-2 py-8 mx-4 leading-6 text-center border-solid sm:flex-row sm:items-start sm:text-left">
                                ...
                                <div className="mt-4 font-sans text-left text-gray-700 border-0 border-gray-200 sm:mt-2 sm:ml-4">
                                    ...
                                    <p className="box-border mx-0 mt-1 mb-0 font-medium leading-loose text-gray-400 border-solid sm:mt-4">
                                        Full compatiblity with all of Instagram: posts, Reels, comments and more.
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <section className="py-16 bg-white md:py-20 lg:py-24" data-tails-scripts="//unpkg.com/alpinejs">
                    <div className="max-w-5xl px-12 mx-auto xl:px-0">
                        ...
                        <div className="relative mt-12 space-y-3">
                            <div {/* x-data="{ show: false }" */} className="relative overflow-hidden border-b border-gray-100 select-none">
                                <h4 {/* @click="show=!show" */} className="flex items-center justify-between px-2 text-lg font-medium text-gray-700 cursor-pointer sm:text-xl md:text-2xl py-7 hover:text-gray-900">
                                    <span className="">Which social media platforms do you support?</span>
                                    <svg className="w-6 h-6 mr-2 transition-all duration-200 ease-out transform rotate-0" {/* :className="{ '-rotate-180' : show }" */} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
                                </h4>
                                <p className="px-2 pt-0 -mt-2 text-gray-400 sm:text-lg py-7" x-transition:enter="transition-all ease-out duration-300" x-transition:enter-start="opacity-0 transform -translate-y-4" x-transition:enter-end="opacity-100 transform -translate-y-0" x-transition:leave="transition-all ease-in duration-300" x-transition:leave-start="opacity-100 transform -translate-y-0" x-transition:leave-end="opacity-0 transform -translate-y-4" x-show="show" {/* style="display: none;" */}>We support Tiktok, Instagram, Youtube (+ Youtube Shorts) currently and are working on increasing the amount of supported platforms soon!</p>
                            </div>
                            ...
                            <div {/* x-data="{ show: false }" */} className="relative overflow-hidden border-b border-gray-100 select-none">
                                ...
                                <p className="px-2 pt-0 -mt-2 text-gray-400 sm:text-lg py-7" x-transition:enter="transition-all ease-out duration-300" x-transition:enter-start="opacity-0 transform -translate-y-4" x-transition:enter-end="opacity-100 transform -translate-y-0" x-transition:leave="transition-all ease-in duration-300" x-transition:leave-start="opacity-100 transform -translate-y-0" x-transition:leave-end="opacity-0 transform -translate-y-4" x-show="show" {/* style="display: none;" */}>You can clone any video posted to any of your social media platforms to accounts on other platforms. Say you edit and post a Tiktok, with the press of a few buttons it can be automatically reposted on Instagram Reels, Youtube Shorts, etc.</p>
                            </div>
                            ...
                            <div {/* x-data="{ show: false }" */} className="relative overflow-hidden border-b border-gray-100 select-none">
                                ...
                                <p className="px-2 pt-0 -mt-2 text-gray-400 sm:text-lg py-7" x-transition:enter="transition-all ease-out duration-300" x-transition:enter-start="opacity-0 transform -translate-y-4" x-transition:enter-end="opacity-100 transform -translate-y-0" x-transition:leave="transition-all ease-in duration-300" x-transition:leave-start="opacity-100 transform -translate-y-0" x-transition:leave-end="opacity-0 transform -translate-y-4" x-show="show" {/* style="display: none;" */}>We currently do not have a mobile app, but it is in the works and should be ready soon</p>
                            </div>
                            ...
                            <div {/* x-data="{ show: false }" */} className="relative overflow-hidden border-b border-gray-100 select-none">
                                ...
                                <p className="px-2 pt-0 -mt-2 text-gray-400 sm:text-lg py-7" x-transition:enter="transition-all ease-out duration-300" x-transition:enter-start="opacity-0 transform -translate-y-4" x-transition:enter-end="opacity-100 transform -translate-y-0" x-transition:leave="transition-all ease-in duration-300" x-transition:leave-start="opacity-100 transform -translate-y-0" x-transition:leave-end="opacity-0 transform -translate-y-4" x-show="show" {/* style="display: none;" */}>Absolutely, we have an SDK for most of the popular languages and frameworks. Be sure to visit our <a href="#_" className="font-medium text-purple-600 underline" data-primary="purple-600">list of SDK's</a> to learn how you can build on top of our service.</p>
                            </div>
                            ...
                            <div {/* x-data="{ show: false }" */} className="relative overflow-hidden border-b border-gray-100 select-none">
                                ...
                                <p className="px-2 pt-0 -mt-2 text-gray-400 sm:text-lg py-7" x-transition:enter="transition-all ease-out duration-300" x-transition:enter-start="opacity-0 transform -translate-y-4" x-transition:enter-end="opacity-100 transform -translate-y-0" x-transition:leave="transition-all ease-in duration-300" x-transition:leave-start="opacity-100 transform -translate-y-0" x-transition:leave-end="opacity-0 transform -translate-y-4" x-show="show" {/* style="display: none;" */}>Yes. We are utilizing <a href="https://paddle.com" className="font-medium text-purple-600 underline" data-primary="purple-600">paddle</a>, which has a fully functional affiliate program. <a href="#_" className="font-medium text-purple-600 underline" data-primary="purple-600">Click here</a> to signup as an affiliate.</p>
                            </div>
                        </div>
                    </div>
                </section>
